...
public class Savecollection {
	public static Response savecollection(String consumerKey, String consumerSecret,int bookID1,int bookID2){
		
		Response jsonResponse = null;
		try {
			String Savecollection= "{\"collection\":{\"clientCollectionId\":\""+EpochTime.current()+"\",\"title\":\"Hey World\",\"coverImage\":"
