		...
		try {
			...
			{	
				...
				if(catlevel.contains("1")){
					bookID20 = fetchBookList_without_pagination.then().extract().path("bookList.book.id[20]");
					System.out.println("bookID_1: "+bookID1);
					bookID21 = fetchBookList_without_pagination.then().extract().path("bookList.book.id[21]");			
					System.out.println("bookID2: "+bookID2);
					bookID22 = fetchBookList_without_pagination.then().extract().path("bookList.book.id[22]");			
					System.out.println("bookID2: "+bookID22);}
				bookID1 = fetchBookList_without_pagination.then().extract().path("bookList.book.id[7]");
				System.out.println("bookID_1: "+bookID1);
				bookID2 = fetchBookList_without_pagination.then().extract().path("bookList.book.id[8]");			
				System.out.println("bookID2: "+bookID2);
				bookID3 = fetchBookList_without_pagination.then().extract().path("bookList.book.id[9]");			
				System.out.println("bookID2: "+bookID3);
				...
				if(catlevel .contains("1")){
					archiveDate = fetchBookList_without_pagination.then().extract().path("bookList.book.archiveDate[20]");
					System.out.println("archiveDate:"+archiveDate);
					archiveDate6=fetchBookList_without_pagination.then().extract().path("bookList.book.archiveDate[21]");
					System.out.println("archiveDate:"+archiveDate);	}
				if(catlevel .contains("2")){
					archiveDate = fetchBookList_without_pagination.then().extract().path("bookList.book.archiveDate[7]");
					System.out.println("archiveDate:"+archiveDate);
					archiveDate6=fetchBookList_without_pagination.then().extract().path("bookList.book.archiveDate[8]");
					System.out.println("archiveDate:"+archiveDate);	}


				if(catlevel.contains("1")){
					Response catbooklistv1 = CategoryBookListV1.categoryBookListV1(catname, userToken, "das3232", "IPAD", bookID20, catlevel, sqlhost,sqlUsername,sqlPassword);
					...
					//String sqlhost  = "jdbc:mysql=//172.18.10.147:3306";
					//String sqlUsername = "readonly";
					//String sqlPassword = "readonly@123";
					Response CategoryBookListV2Res = CategoryBookListV2.categoryBookListV2(""+category1+"",userToken,"56454", "IPAD",bookID20,catlevel,sqlhost,sqlUsername,sqlPassword);
					...
					Response CategoryBookListV2Res_withpagi = CategoryBookListV2.categoryBookListV2_withpagi(0,10,""+category1+"",userToken,"56454", "IPAD",bookID20,catlevel,sqlhost,sqlUsername,sqlPassword);
					...
					//2019/10/31 14:46:04  //
					Response v1refreshBookList_res  =V1refreshBookList.v1refreshBookList(""+archiveDate+"","NEW","UPDATE",""+bookID20+"",""+bookID21+"",userToken,"56454", "IPAD",clientID);
					...
					Response MultiCategoryBookList_res = MultiCategoryBookList.multiCategoryBookList(catlevel,bookID20,sqlhost,sqlUsername,sqlPassword,userToken,"45564595","IPAD");
					if(catlevel.contains ("1")){}			
					...
					Response MultiCategoryCollection_BookList=MultiCategoryCollectionBookList.multiCategoryCollectionBookList(catlevel, bookID20, sqlhost,sqlUsername,sqlPassword, userToken, "4524242", "IPAD", collectionName0);
					if(catlevel.contains ("1")){}	
					...
					Response fetchCategoriesCollectionsBooksres =FetchCategoriesCollectionsBooks.fetchCategoriesCollectionsBooks(userToken, "5489989","IPAD","level4_upd",collectionName0);
					...
					Response markAsFavourite_res = MarkAsFavourite.markAsFavourite(bookID20,userToken,"45564595","IPAD");
					...
					Response markAsFavourite_res1 = MarkAsFavourite.markAsFavourite(bookID21,userToken,"45564595","IPAD");
					BookID_mark2 = bookID21;
					...
					Response downloadBookForANDROID_offline = DownloadBook.downloadBook(userToken,"ds9465","IPAD",bookID20,"offline");
					...
					Response downloadBookForANDROID_online = DownloadBook.downloadBook(userToken,"ds9465","IPAD",bookID20,"online");
					...
					Response bulkDownloadBook= BulkDownloadBook.bulkDownloadBook(userToken, "GHgah242", "IPAD", bookID20, bookID21, bookID22, "offline");
					...
					Response catbooklistv1 = CategoryBookListV1.categoryBookListV1(catname, userToken, "das3232", "IPAD", bookID1, catlevel, sqlhost,sqlUsername,sqlPassword);
					Validation.responseHeaderCodeValidation(catbooklistv1, HttpStatus.SC_OK);
					Validation.responseCodeValidation1(catbooklistv1, HttpStatus.SC_OK);
					Validation.responseTimeValidation(catbooklistv1);
					Validation.responseKeyValidation_key(catbooklistv1,"archiveDate");
					...
					Response fetchCategoriesCollectionsBooksres =FetchCategoriesCollectionsBooks.fetchCategoriesCollectionsBooks(userToken, "5489989","IPAD","level3_upd",collectionName0);
					Validation.responseHeaderCodeValidation(fetchCategoriesCollectionsBooksres, HttpStatus.SC_OK);
					Validation.responseCodeValidation1(fetchCategoriesCollectionsBooksres,HttpStatus.SC_OK);
					Validation.responseTimeValidation(fetchCategoriesCollectionsBooksres);
					Validation.responseKeyValidation_key(fetchCategoriesCollectionsBooksres, "archiveDate");
					...
					Response downloadBookForANDROID_offline = DownloadBook.downloadBook(userToken,"ds9465","IPAD",bookID1,"offline");
					Validation.responseCodeValidation1(downloadBookForANDROID_offline, HttpStatus.SC_OK);
					Validation.responseTimeValidation(downloadBookForANDROID_offline);
					Validation.responseKeyValidation_key(downloadBookForANDROID_offline,"fileSize");
					Validation.responseKeyValidation_key(downloadBookForANDROID_offline,"responseMsg");
...
//ipad //online excel dropdon swithcase statements validation
					Response downloadBookForANDROID_online = DownloadBook.downloadBook(userToken,"ds9465","IPAD",bookID1,"online");
					Validation.responseHeaderCodeValidation(downloadBookForANDROID_online, HttpStatus.SC_OK);
					Validation.responseCodeValidation1(downloadBookForANDROID_online, HttpStatus.SC_OK);
					Validation.responseTimeValidation(downloadBookForANDROID_online);
					Validation.responseKeyValidation_key(downloadBookForANDROID_online,"fileSize");
					...
					downloadBookForANDROID_online = DownloadBook.downloadBook(userToken,"ds9465","HTML5",bookID1,"online");
					Validation.responseHeaderCodeValidation(downloadBookForANDROID_online, HttpStatus.SC_OK);
					Validation.responseCodeValidation1(downloadBookForANDROID_online, HttpStatus.SC_OK);
					Validation.responseTimeValidation(downloadBookForANDROID_online);
					//Validation.responseKeyValidation_key(downloadBookForANDROID_online,"fileSize");
					...
					Response bulkDownloadBook= BulkDownloadBook.bulkDownloadBook(userToken, "GHgah242", "HTML5", bookID1, bookID2, bookID3, "offline");
					Validation.responseHeaderCodeValidation(bulkDownloadBook, HttpStatus.SC_OK);
					Validation.responseCodeValidation1(bulkDownloadBook, HttpStatus.SC_OK);
					Validation.responseTimeValidation(bulkDownloadBook);
					//Validation.responseKeyValidation_key(bulkDownloadBook,"fileSize");
