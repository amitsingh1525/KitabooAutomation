...
public class DIS_1964 {
	...
	public static void   main(String []args) throws SQLException, JSONException{
		...
		try {
			...
			Response downloadBookForANDROID_offline = DownloadBook.downloadBook(userToken,"ds9465",deviceT[i4],bookID1,"offline");			
			...
			Response downloadBookForANDROID_online = DownloadBook.downloadBook(userToken,"ds9465",deviceT[i4],bookID1,"online");
