...
public class ProdUS_Sanity {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			Response downloadBook1 = DownloadBook_ext.downloadBook_ext(consumerKey, consumerSecret, bookID1,"sds4344", deviceType);
			Log.info("detail : " +detail);
			...
			String formate = JDBC_Queries.getFormate(bookID1,sqlhost,sqlUsername,sqlPassword);
			if(formate.equals("IPAD"))
			{formate1 = JDBC_Queries.getFormate_3(bookID1,sqlhost,sqlUsername,sqlPassword);
			formate2 = JDBC_Queries.getFormate_5(bookID1,sqlhost,sqlUsername,sqlPassword);
			formate3 = JDBC_Queries.getFormate_12(bookID1,sqlhost,sqlUsername,sqlPassword);
			formate4 = JDBC_Queries.getFormate_13(bookID1,sqlhost,sqlUsername,sqlPassword);
			}
			formate5 = JDBC_Queries.getFormate(bookID2,sqlhost,sqlUsername,sqlPassword);	


			Response downloadBook = DownloadBook.downloadBook(userToken,"ds9465",formate,bookID1,"offline");
			...
			downloadBook = DownloadBook.downloadBook(userToken,"gfdsa2345",formate1,bookID1,"offline");
			Validation.responseCodeValidation1(downloadBook, HttpStatus.SC_OK);
			Validation.responseTimeValidation(downloadBook);
			Validation.responseKeyValidation_key(downloadBook,"content_ownership");
			...
			downloadBook = DownloadBook.downloadBook(userToken,"ds9465",formate2,bookID1,"online");
			Validation.responseCodeValidation1(downloadBook, HttpStatus.SC_OK);
			Validation.responseTimeValidation(downloadBook);
			Validation.responseKeyValidation_key(downloadBook,"content_ownership");
			content_ownership=downloadBook.then().extract().path("content_ownership");
			...
			downloadBook = DownloadBook.downloadBook(userToken,"ds9465",formate3,bookID1,"online");
			Validation.responseCodeValidation1(downloadBook, HttpStatus.SC_OK);
			Validation.responseTimeValidation(downloadBook);
			Validation.responseKeyValidation_key(downloadBook,"content_ownership");
			content_ownership=downloadBook.then().extract().path("content_ownership");
			...
			downloadBook = DownloadBook.downloadBook(userToken,"ds9465",formate4,bookID1,"online");
			Validation.responseCodeValidation1(downloadBook, HttpStatus.SC_OK);
			Validation.responseTimeValidation(downloadBook);
			Validation.responseKeyValidation_key(downloadBook,"content_ownership");
			content_ownership=downloadBook.then().extract().path("content_ownership");
			...
			downloadBook = DownloadBook.downloadBook(userToken,"ds9465",formate5,bookID2,"online");
